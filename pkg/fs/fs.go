// Copyright 2023 The Go Authors and Dmitry Lakhno. All rights reserved.
// Use of this source code is governed by a BSD-style

// Source of this file is: https://github.com/golang/dep/blob/v0.5.4/internal/fs/fs.go
package fs
...
func copyFile(src, dst string) (err error) {
	...
	SetChmodAndChown(dst, si)

	return
}

// Set the mode and ownership of the given path to match the given os.FileInfo.
func SetChmodAndChown(path string, mode os.FileInfo) error {
	if err := os.Chmod(path, mode.Mode()); err != nil {
		return err
	}

	if stat, ok := mode.Sys().(*syscall.Stat_t); ok {
